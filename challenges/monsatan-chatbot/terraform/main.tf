...
resource "incus_network" "this" {
  ...
  config = {
    ...
    "ipv6.address" = "9000:d37e:c40b:51e0::1/64"
...
locals {
  instances = {
    # `monsatan-chatbot` can be changed to something more relevant
    monsatan-chatbot = {
      "description" : "Monsatan's Chatbot",
      # This second half of a MAC address was automatically generated. The first half is just below
      "hwaddr" : "00:16:3e:7f:9c:b3",
...
resource "incus_network_zone_record" "this" {
  ...
  entry {
    ...
    value = "9000:d37e:c40b:51e0:${each.value["ipv6"]}"
  }
}
...
#    type  = "AAAA"
#    ttl   = 3600
#    value = "9000:d37e:c40b:51e0:${local.instances["challenge5"]["ipv6"]}"
#  }
#}
