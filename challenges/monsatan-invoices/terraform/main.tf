...
resource "incus_network" "this" {
  ...
  config = {
    ...
    "ipv6.address" = "9000:d37e:c40b:acbf::1/64"
...
locals {
  instances = {
    # `monsatan-invoices` can be changed to something more relevant
    monsatan-invoices = {
      "description" : "Verdachem Industries website",
      # This second half of a MAC address was automatically generated. The first half is just below
      "hwaddr" : "00:16:3e:72:df:5e",
...
resource "incus_network_zone_record" "this" {
  ...
  entry {
    ...
    value = "9000:d37e:c40b:acbf:${each.value["ipv6"]}"
  }
}
...
#    type  = "AAAA"
#    ttl   = 3600
#    value = "9000:d37e:c40b:acbf:${local.instances["challenge5"]["ipv6"]}"
#  }
#}
